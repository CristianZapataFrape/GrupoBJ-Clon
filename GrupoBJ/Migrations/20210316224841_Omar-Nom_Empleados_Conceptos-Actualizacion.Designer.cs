...
namespace GrupoBJ.Migrations
{
    ...
    [Migration("20210316224841_Omar-Nom_Empleados_Conceptos-Actualizacion")]
    partial class OmarNom_Empleados_ConceptosActualizacion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Agrupadores_SAT", b =>
                {
                    b.Property<int>("idAgrupadorSAT")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("idAgrupadorSAT");

                    b.ToTable("Agrupadores_SAT");
                });

            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Agrupadores_SAT_Rubros_NIF", b =>
                {
                    b.Property<int>("idAgrupadoresSATRubrosNIF")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("fkAgrupadoresSAT")
                        .IsRequired()
                        .HasColumnType("int");

                    b.Property<int?>("fkRubrosNIF")
                        .IsRequired()
                        .HasColumnType("int");

                    b.HasKey("idAgrupadoresSATRubrosNIF");

                    b.HasIndex("fkAgrupadoresSAT");

                    b.HasIndex("fkRubrosNIF");

                    b.ToTable("Agrupadores_SAT_Rubros_NIF");
                });
            ...
            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Cuentas", b =>
                {
                    ...
                    b.HasIndex("fkTipoCuenta");

                    b.ToTable("Cuentas");
                });

            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Diarios_Especiales", b =>
                {
                    b.Property<int>("idDiariosEspeciales")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("idDiariosEspeciales");

                    b.HasIndex("fkTipoDiario");

                    b.ToTable("Diarios_Especiales");
                });

            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Diarios_Especiales_Rubros_NIF", b =>
                {
                    b.Property<int>("idDiariosEspecialesRubrosNIF")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("fkDiariosEspeciales")
                        .IsRequired()
                        .HasColumnType("int");
                    ...
                    b.HasKey("idDiariosEspecialesRubrosNIF");

                    b.HasIndex("fkDiariosEspeciales");

                    b.HasIndex("fkRubrosNIF");

                    b.ToTable("Diarios_Especiales_Rubros_NIF");
                });
            ...
            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Tipo_Cuenta", b =>
                {
            ...
            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Tipo_Diario", b =>
                {
                    b.Property<int>("idTipoDiario")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("idTipoDiario");

                    b.ToTable("Tipo_Diario");
                });

            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Tipo_Diario_Rubros_NIF", b =>
                {
                    b.Property<int>("idTipoDiarioRubrosNIF")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("idTipoDiarioRubrosNIF");

                    b.HasIndex("fkRubrosNIF");

                    b.HasIndex("fkTipoDiario");

                    b.ToTable("Tipo_Diario_Rubros_NIF");
                });
            ...
            modelBuilder.Entity("GrupoBJ.Models.Nominas.Nom_Conceptos", b =>
                {
                    ...
                    b.Property<bool?>("automaticoGlobal")
                        .HasColumnType("bit");

                    b.Property<bool?>("automaticoLiquidacion")
                        .HasColumnType("bit");

                    b.Property<string>("claveAgrupadoraSAT")
                        .HasColumnType("nvarchar(2)")
                        .HasMaxLength(2);

                    b.Property<string>("contabilizacionContraCuenta")
                        .HasColumnType("nvarchar(1)");

                    b.Property<string>("contabilizacionCuenta")
                        .HasColumnType("nvarchar(1)");

                    b.Property<string>("contraCuentaContable")
                        .HasColumnType("nvarchar(30)")
                        .HasMaxLength(30);
                    ...
                    b.Property<string>("cuentaExcentoDeduc")
                        .HasColumnType("nvarchar(30)")
                        .HasMaxLength(30);

                    b.Property<string>("cuentaExcentoNoDeduc")
                        .HasColumnType("nvarchar(30)")
                        .HasMaxLength(30);

                    b.Property<string>("cuentaGravado")
                        .HasColumnType("nvarchar(30)")
                        .HasMaxLength(30);
                    ...
                    b.Property<string>("formulaImporte1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("formulaImporte2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("formulaImporte3")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("formulaImporte4")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("formulaImporteTotal")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("formulaValor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("leyendaImporte1")
                        .HasColumnType("nvarchar(40)")
                        .HasMaxLength(40);

                    b.Property<string>("leyendaImporte2")
                        .HasColumnType("nvarchar(40)")
                        .HasMaxLength(40);

                    b.Property<string>("leyendaImporte3")
                        .HasColumnType("nvarchar(40)")
                        .HasMaxLength(40);

                    b.Property<string>("leyendaImporte4")
                        .HasColumnType("nvarchar(40)")
                        .HasMaxLength(40);

                    b.Property<string>("leyendaValor")
                        .HasColumnType("nvarchar(40)")
                        .HasMaxLength(40);
                    ...
                    b.Property<string>("tipoClaveSAT")
                        .HasColumnType("nvarchar(2)")
                        .HasMaxLength(2);
                    ...
                    b.Property<string>("tipoMovimientoContable")
                        .HasColumnType("nvarchar(1)");

                    b.HasKey("idConcepto");

                    b.ToTable("Nom_Conceptos");
                });

            modelBuilder.Entity("GrupoBJ.Models.Nominas.Nom_ControlVacaciones", b =>
                {
                    b.Property<int>("idControlVacaciones")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<double?>("diasPrimaVacacional")
                        .HasColumnType("float");
                    ...
                    b.HasKey("idControlVacaciones");

                    b.HasIndex("fkEmpleado");

                    b.ToTable("Nom_ControlVacaciones");
                });

            modelBuilder.Entity("GrupoBJ.Models.Nominas.Nom_Empleados_Conceptos", b =>
                {
                    b.Property<int>("idEmpleadosConceptos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("idEmpleadosConceptos");

                    b.HasIndex("fkConcepto");

                    b.HasIndex("fkEmpleado");

                    b.ToTable("Nom_Empleados_Conceptos");
                });
            ...
            modelBuilder.Entity("GrupoBJ.Models.Nominas.Nom_HistorialAltaBajaReingreso", b =>
                {
                    b.Property<int>("idAltaBajaReingreso")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("idAltaBajaReingreso");

                    b.HasIndex("fkEmpleado");

                    b.HasIndex("fkPeriodo");

                    b.ToTable("Nom_HistorialAltaBajaReingreso");
                });

            modelBuilder.Entity("GrupoBJ.Models.Nominas.Nom_HistorialSueldos", b =>
                {
                    b.Property<int>("idHistorialSueldo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("tipoSueldo")
                        .HasColumnType("nvarchar(1)");

                    b.HasKey("idHistorialSueldo");
                    ...
                    b.ToTable("Nom_HistorialSueldos");
                });
            ...
            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Agrupadores_SAT_Rubros_NIF", b =>
                {
                    b.HasOne("GrupoBJ.Models.Contabilidad.Agrupadores_SAT", "Agrupadores_SAT")
                        .WithMany()
                        .HasForeignKey("fkAgrupadoresSAT")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GrupoBJ.Models.Contabilidad.Rubros_NIF", "Rubros_NIF")
                        .WithMany()
                        .HasForeignKey("fkRubrosNIF")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Cuentas", b =>
                {
                    ...
                    b.HasOne("GrupoBJ.Models.Contabilidad.Tipo_Cuenta", "Tipo_Cuenta")
                        .WithMany()
                        .HasForeignKey("fkTipoCuenta")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Diarios_Especiales", b =>
                {
                    b.HasOne("GrupoBJ.Models.Contabilidad.Tipo_Diario", "Tipo_Diario")
                        .WithMany()
                        .HasForeignKey("fkTipoDiario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("GrupoBJ.Models.Contabilidad.Diarios_Especiales_Rubros_NIF", b =>
                {
                    b.HasOne("GrupoBJ.Models.Contabilidad.Diarios_Especiales", "Diarios_Especiales")
                        .WithMany()
                        .HasForeignKey("fkDiariosEspeciales")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GrupoBJ.Models.Nominas.Nom_ControlVacaciones", b =>
                {
                    b.HasOne("GrupoBJ.Models.Empleado", "Empleado")
                        .WithMany()
            ...
            modelBuilder.Entity("GrupoBJ.Models.Nominas.Nom_Empleados_Conceptos", b =>
                {
                    b.HasOne("GrupoBJ.Models.Nominas.Nom_Conceptos", "Nom_Conceptos")
                        .WithMany()
                        .HasForeignKey("fkConcepto")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

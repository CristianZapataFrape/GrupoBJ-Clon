...
namespace GrupoBJ.Migrations
{
    ...
    [Migration("20210203162640_Arquimides_Articulos_Carateristicas_Modificacion")]
    partial class Arquimides_Articulos_Carateristicas_Modificacion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrupoBJ.Models.Areas_Trabajo", b =>
                {
                    b.Property<int>("id_Areas_Trabajo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("Nombre_Area_Trabajo")
                        .IsRequired()
                        .HasColumnType("nvarchar(150)")
                        .HasMaxLength(150);

                    b.Property<int>("Transferencias_Por_Articulo")
                        .HasColumnType("int");
                    ...
                    b.HasKey("id_Areas_Trabajo");

                    b.HasIndex("idEmpresa");

                    b.HasIndex("idHorario");

                    b.ToTable("Areas_Trabajo");
                });
            ...
            modelBuilder.Entity("GrupoBJ.Models.Articulos_Areas_Trabajo", b =>
                {
                    b.Property<int>("id_Articulos_Areas_Trabajo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("id_Articulos_Areas_Trabajo");

                    b.HasIndex("id_Areas_Trabajo");

                    b.HasIndex("id_Articulos");

                    b.ToTable("Articulos_Areas_Trabajo");
                });
            ...
            modelBuilder.Entity("GrupoBJ.Models.Empleado", b =>
                {
                    ...
                    b.Property<float>("diasPrimaVacTomadasAntesDeAlta")
                        .HasColumnType("real");

                    b.Property<float>("diasVacacionesTomadasAntesDeAlta")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("porcentajePensionAlimenticia")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("sueldoBaseLiquidacion")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("sueldoIntegrado")
                        .HasColumnType("real");

                    b.Property<float>("sueldoMixto")
                        .HasColumnType("real");

                    b.Property<float>("sueldoNetoMensual")
                        .HasColumnType("real");

                    b.Property<float>("sueldoPromedio")
                        .HasColumnType("real");

                    b.Property<float>("sueldoVariable")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("GrupoBJ.Models.Areas_Trabajo", b =>
                {
                    ...
                    b.HasOne("GrupoBJ.Models.Horario", "Horario")
                        .WithMany()
            ...
            modelBuilder.Entity("GrupoBJ.Models.Articulos_Areas_Trabajo", b =>
                {
                    b.HasOne("GrupoBJ.Models.Areas_Trabajo", "Areas_Trabajo")
                        .WithMany()
                        .HasForeignKey("id_Areas_Trabajo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
